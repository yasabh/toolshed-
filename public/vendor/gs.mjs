...
var w = d.print || console.log.bind(console), v = d.printErr || console.warn.bind(console);
Object.assign(d, ca);
ca = null;
y("ENVIRONMENT");
...
if (d.locateFile) {
  ...
  J = (new URL("gs.wasm", import.meta.url)).toString();
}
function eb() {
  var a = J;
  try {
